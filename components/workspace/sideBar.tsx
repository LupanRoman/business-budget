...
function SideBar({}: Props) {
  ...
  return (
    <>
      <div className="relative flex items-center justify-center bg-accentColor text-white py-5 lg:rounded-r-3xl lg:h-full lg:max-w-[200px] lg:flex-col lg:items-start lg:justify-normal lg:gap-5 lg:px-3 lg:py-0">
